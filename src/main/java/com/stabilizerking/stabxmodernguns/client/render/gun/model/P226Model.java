...
public class P226Model implements IOverrideModel {
    ...
    public void render(float partialTicks, ItemDisplayContext display, ItemStack stack, ItemStack parent, LivingEntity entity, PoseStack matrix, MultiBufferSource renderingbuffer, int light, int overlay){
        ...
        RenderUtil.renderModel(SpecialModels.P226.getModel(), stack, matrix, renderingbuffer, light, overlay);
        ...
        if(entity.equals(Minecraft.getInstance().player)) {
            ...
            RenderUtil.renderModel(SpecialModels.P226_SLIDER.getModel(), stack, matrix, renderingbuffer, light, overlay);
            matrix.popPose();
