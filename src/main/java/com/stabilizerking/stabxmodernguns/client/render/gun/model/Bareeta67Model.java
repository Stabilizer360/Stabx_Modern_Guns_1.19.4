...
public class Bareeta67Model implements IOverrideModel {
    ...
    public void render(float partialTicks, ItemDisplayContext display, ItemStack stack, ItemStack parent, LivingEntity entity, PoseStack matrix, MultiBufferSource renderingbuffer, int light, int overlay){
        ...
        RenderUtil.renderModel(SpecialModels.BAREETA67.getModel(), stack, matrix, renderingbuffer, light, overlay);
        ...
        if(entity.equals(Minecraft.getInstance().player)) {
            ...
            RenderUtil.renderModel(SpecialModels.Bareeta67_SLIDER.getModel(), stack, matrix, renderingbuffer, light, overlay);
            matrix.popPose();
        }
    }
}