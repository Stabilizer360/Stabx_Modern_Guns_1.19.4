...
public class Glock19cModel implements IOverrideModel {
    ...
    public void render(float partialTicks, ItemDisplayContext display, ItemStack stack, ItemStack parent, LivingEntity entity, PoseStack matrix, MultiBufferSource renderingbuffer, int light, int overlay){
        ...
        RenderUtil.renderModel(SpecialModels.GLOCK_19_C.getModel(), stack, matrix, renderingbuffer, light, overlay);
        ...
        if(entity.equals(Minecraft.getInstance().player)) {
            ...
            RenderUtil.renderModel(SpecialModels.GLOCK_19_C_SLIDER.getModel(), stack, matrix, renderingbuffer, light, overlay);
            matrix.popPose();
        }
    }
}